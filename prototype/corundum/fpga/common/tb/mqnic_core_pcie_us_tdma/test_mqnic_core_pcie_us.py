...
async def run_test_nic(dut):
    ...
    for q in tb.driver.interfaces[0].ndevs[0].txq:
        await tb.driver.interfaces[0].sched_blocks[0].schedulers[0].hw_regs.write_dword(4*q.index, 0x00000001)
    ...
    # send packets
    for k in range(count):
        await tb.driver.interfaces[0].ndevs[0].start_xmit(pkts[k], k % 4)
