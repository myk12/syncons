...
localparam integer DATA_WORD_COUNT              = RAM_SEG_COUNT * RAM_SEG_DATA_WIDTH / 32;
...
wire [31:0] beat_index_word = beat_index_reg;
wire [31:0] pattern_word = 32'hc000_0000 ^ generated_count_reg ^ (beat_index_word << 16);

assign commit_in_data = {DATA_WORD_COUNT{pattern_word}};
assign commit_in_be     = FULL_BE;
assign commit_in_last   = beat_index_reg == COMMIT_LAST_BEAT_INDEX;
assign commit_in_valid  = busy_reg && (generated_count_reg < target_count_reg);
